...
class Testimonial(BaseModel):
    ...
    client_name = models.CharField(
        max_length=100, db_index=True, help_text="Full name of the client"
    )

    client_profession = models.CharField(
        max_length=100, blank=True, help_text="Profession or designation of the client"
    )
    ...
    display_order = models.PositiveSmallIntegerField(
        default=0, help_text="Lower number = higher position"
    )

    is_featured = models.BooleanField(
        default=False, help_text="Check to feature this testimonial on homepage"
    )
